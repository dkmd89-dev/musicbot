...
from utils.title_cleanup import light_title_cleanup as _light_title_cleanup
...
class TitleCleaner:
    ...
    def light_title_cleanup(self, title: str, artist: str) -> str:
        ...
        Returns:
            Bereinigter Titel
        """
        # Reine Regex-Logik ausgelagert nach utils/title_cleanup.py (kein
        # Zustand, kein I/O) — damit der read-only Library-Health-Scanner
        # dieselbe Bereinigung nutzen kann, ohne services/metadata/ (mit
        # TagWriter/EnhancedMetadataProcessor im __init__) in seinen
        # Import-Graph zu ziehen. Verhalten unveraendert; Tests
        # tests/test_title_cleaner_*.py bleiben die Charakterisierung.
        return _light_title_cleanup(title, artist)
