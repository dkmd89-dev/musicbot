...
Dieses Projekt wird nicht neu geschrieben, sondern kontrolliert weiterentwickelt: bestehendes Verhalten zuerst verstehen und mit Characterization-Tests absichern, dann verbessern. Die verbindlichen Arbeitsregeln stehen in [`CLAUDE.md`](CLAUDE.md); der aktuelle Stand aller bekannten Risiken, offenen Punkte und der Technical-Debt-Liste in [`docs/MusicBot_ENGINEERING_BASELINE_v3.md`](docs/MusicBot_ENGINEERING_BASELINE_v3.md) (löst [`docs/archive/MusicBot_ENGINEERING_BASELINE_v2.md`](docs/archive/MusicBot_ENGINEERING_BASELINE_v2.md), eingefrorener Closure-Stand vom 2026-08-25 mit 1057 passed/0 failed, als aktuellen Referenzpunkt ab; `docs/archive/MusicBot_ENGINEERING_BASELINE.md` bleibt als noch ältere, historische Referenz vom 2026-08-16 unverändert bestehen). Ältere Architektur-Analysen (ARCH-xxx/POST-ARCH-xxx) liegen vollständig erhalten unter [`docs/archive/`](docs/archive/), siehe [`docs/INDEX.md`](docs/INDEX.md).
