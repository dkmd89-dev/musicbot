...
|---|---|---|---|
| **INV-01** (`services/duplicate/cache.py`) | **OPEN / DEFER** | **P2** | Synchrone Filesystem-Persistenz im Event-Loop-Thread. Nicht Teil von Phase 3, aus einem früheren Architektur-Audit ([`docs/audits/SERVICES_ARCHITECTURE_AUDIT_2026-09-01.md`](audits/SERVICES_ARCHITECTURE_AUDIT_2026-09-01.md) §22, [`docs/MusicBot_ENGINEERING_BASELINE_v8.md`](MusicBot_ENGINEERING_BASELINE_v8.md) §6/8) — hier zur Vollständigkeit referenziert, da im Repository weiterhin unverändert offen. „Mass conversion to async" bleibt laut Architecture-Evolution-Gate verboten. |
