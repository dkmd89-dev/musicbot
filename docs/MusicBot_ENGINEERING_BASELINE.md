...
- [ ] Telegram-Handler-Layer testen — begonnen mit `UserManagementHandler` (TEST-009/SEC-005) und `BackupHandler` (TEST-010/SEC-006); `rich_menu_handler.py`, `rich_menu_system.py` (über SEC-003-Ausschnitt hinaus), `enhanced_error_handler.py`, `navidrome_menu_handler.py`, `enhanced_status_handler.py`, `mugge_statistik_handler.py` weiterhin ungetestet (~8.200 Zeilen)
