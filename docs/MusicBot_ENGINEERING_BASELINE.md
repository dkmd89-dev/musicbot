...
- [ ] weitere Orchestrator-Extraktionen (verbleibende Kandidaten aus ARCH-001, jeweils eigene Freigabe): Workflow-State-Machine aus `RichMenuHandler`, `CallbackRouter`-Abstraktion für `RichMenuSystem`
