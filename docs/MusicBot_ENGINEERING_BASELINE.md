...
- [ ] weitere Orchestrator-Extraktionen (verbleibende Kandidaten aus ARCH-001, jeweils eigene Freigabe): Telegram-Ergebnisformatierung aus `DownloadHandler`, Workflow-State-Machine aus `RichMenuHandler`, `CallbackRouter`-Abstraktion für `RichMenuSystem`
