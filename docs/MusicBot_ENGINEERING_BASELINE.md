...
- [ ] Telegram-Handler-Layer testen — begonnen mit `UserManagementHandler` (TEST-009/SEC-005), `BackupHandler` (TEST-010/SEC-006) und `rich_menu_system.py` (TEST-011); `rich_menu_handler.py`, `enhanced_error_handler.py`, `navidrome_menu_handler.py`, `enhanced_status_handler.py`, `mugge_statistik_handler.py` weiterhin ungetestet (~6.300 Zeilen)
