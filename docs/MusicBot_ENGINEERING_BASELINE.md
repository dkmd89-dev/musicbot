...
- [ ] Zielarchitektur schrittweise weiter umsetzen (die drei zurückgestellten DEFER-Punkte aus ARCH-004 Abschnitt 7, die in ARCH-005 Abschnitt 5 dokumentierten Restrisiken, ARCH-009 Phase 3/4 (`execute_scan()`-Auslagerung + spätere Adapter-Zielposition/DI) und die `handlers.duplicate_handler.DuplicateEntry`-Abhängigkeit aus ARCH-007 Abschnitt 4 — je eigene Nutzerentscheidung nötig)
