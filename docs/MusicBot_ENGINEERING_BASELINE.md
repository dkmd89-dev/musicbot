...
- [ ] Telegram-Handler-Layer testen — begonnen mit `UserManagementHandler` (TEST-009/SEC-005), `BackupHandler` (TEST-010/SEC-006), `rich_menu_system.py` (TEST-011) und `enhanced_error_handler.py` (BUG-005); `rich_menu_handler.py`, `navidrome_menu_handler.py`, `enhanced_status_handler.py`, `mugge_statistik_handler.py` weiterhin ungetestet (~3.800 Zeilen)
