...
- [ ] externe Adapter inventarisieren — Navidrome (TEST-005), Genius (REL-002), MusicBrainz (TEST-006), Last.fm (TEST-007) jetzt charakterisiert; Fanart/Cover-Netzwerk/Spotify-Downloader noch offen
