...
| Datei | Status | Kurzthema |
|---|---|---|
| [MusicBot_ENGINEERING_BASELINE_v10.md](MusicBot_ENGINEERING_BASELINE_v10.md) | DRAFT / IN PROGRESS (nicht eingefroren) — laufender Zwischenstand seit dem v9-Freeze (ARCH Status / Recent Major Changes / Testzahlen); Findings weiterhin in [FINDINGS_INDEX.md](FINDINGS_INDEX.md) | Eintrag 1: Artist-Identity-Resolution-Migration (Phase A–F, PR #176) — dedizierter `ArtistIdentityResolver`, `normalize()` reine String-Normalisierung, F-01…F-06 CLOSED, F-07/F-08 DEFERRED. 2920 passed / 1 skipped / 0 failed. |
