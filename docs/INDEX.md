...
| Datei | Status | Kurzthema |
|---|---|---|
| [MusicBot_ENGINEERING_BASELINE_v8.md](MusicBot_ENGINEERING_BASELINE_v8.md) | BASELINE (aktuell, eingefroren nach Freeze 2026-09-02 — für den laufenden Stand siehe [FINDINGS_INDEX.md](FINDINGS_INDEX.md)) | Erster vollständiger P0-Kernbereichs-Audit dieser Baseline-Serie (Metadata/Genre/Artist-Mapping/Duplicate Detection, PR #100, sechs Teilphasen P0-A–F + Gesamtaudit) mit zwei gefundenen und gefixten P0-Bugs (Duplicate-Detection-Artist-Normalisierung, YouTube-Shorts-URL-Erkennung), einem P1-Architekturprojekt zur Ursachenbehebung (PR #102, `DuplicateDetector`↔`ArtistNormalizer`-Verdrahtung), sowie zwei kleinen Cleanup-PRs (#99, #101), 1698 passed / 0 failed (1 umgebungsbedingt skipped) — neue Findings → MusicBot_ENGINEERING_BASELINE_v9.md |
