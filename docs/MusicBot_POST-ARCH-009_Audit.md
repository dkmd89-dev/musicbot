...
**Risiko:** Niedrig — kleiner, isolierter, gut getesteter Baustein (`tests/test_bot_restart_handler.py` existiert bereits mit dediziertem Coverage laut `docs/MusicBot_ENGINEERING_BASELINE.md` TEST-015, 12 Tests).
