...
**💿 Verfügbare Alben:**"""
    ...
    @staticmethod
    def _format_track_duration(seconds: Any) -> str:
    ...
    async def handle_album_detail(
        ...
        try:
            ...
            duration_text = self._format_track_duration(album.get("duration", 0))
            year = album.get("year")
    ...
    async def handle_song_detail(
        ...
        try:
            ...
            year = song.get("year")
            track_num = song.get("track")
            duration_text = self._format_track_duration(song.get("duration", 0))
