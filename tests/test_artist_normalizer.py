...
class TestArtistnorm001FeatFtWordBoundaryFix:
    ...
    # F-08 (Migration Phase E, 2026-09-08): TestSaveAutoLearnedEntryAtomicWrite
    # entfernt - testete ausschliesslich add_auto_learned_alias()/
    # _save_auto_learned_entry(), die als toter Code (0 Aufrufer) entfernt
    # wurden. Der produktive Alias-Lernpfad (AutoLearnManager._save_alias())
    # bleibt ueber tests/test_auto_learn_invariant_fix.py::TestAtomicWrite
    # abgedeckt.
